...
PairHybridScaledKokkos::PairHybridScaledKokkos(LAMMPS *lmp) : PairHybridKokkos(lmp) {}

/* ----------------------------------------------------------------------
   set coeffs for one or more type pairs
------------------------------------------------------------------------- */

void PairHybridScaledKokkos::coeff(int narg, char **arg)
{
...
void PairHybridScaledKokkos::init_svector()
{
...
void PairHybridScaledKokkos::copy_svector(int itype, int jtype)
{
  int n=0;
