...
(:ref:`Yu <Yu>`) and (:ref:`Shan <Shan>`).  It performs the charge
...
atoms with each other.  See :ref:`Rappe and Goddard <Rappe_and_Goddard>` and
:ref:`Rick and Stuart <Rick_and_Stuart>` for details.
...
**(Yu)** J. Yu, S. B. Sinnott, S. R. Phillpot, Phys Rev B, 75, 085311 (2007),

.. _Shan:

**(Shan)** T.-R. Shan, B. D. Devine, T. W. Kemper, S. B. Sinnott, S. R.
Phillpot, Phys Rev B, 81, 125328 (2010).

.. _Rappe_and_Goddard:

**(Rappe and Goddard)** A. K. Rappe, W. A. Goddard, J Phys Chem 95, 3358
(1991).

.. _Rick_and_Stuart:

**(Rick and Stuart)** S. W. Rick, S. J. Stuart, B. J. Berne, J Chem Phys
101, 16141 (1994).
